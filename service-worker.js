const CACHE = 'deutsch-meister-v96';
...
const STATIC = [
  ...
  BASE + '/index.html',
  BASE + '/manifest.json',
  BASE + '/css/base.css?v=81',
  BASE + '/css/sidebar.css?v=81',
  BASE + '/css/lesson.css?v=81',
  BASE + '/css/exercises.css?v=81',
  BASE + '/js/progress.js?v=81',
  BASE + '/js/lesson-render.js?v=81',
  BASE + '/js/exercises.js?v=81',
  BASE + '/js/flashcards.js?v=81',
  BASE + '/js/tts.js?v=81',
  BASE + '/js/telegram.js?v=81',
  BASE + '/js/cloud-sync.js?v=81',
  BASE + '/js/install-app.js?v=81',
  BASE + '/js/support.js?v=81',
  BASE + '/js/sw-register.js?v=81',
  ...
  BASE + '/books.html',
  BASE + '/css/reader.css?v=81',
  BASE + '/js/library.js?v=81',
  BASE + '/js/reader.js?v=81',
  BASE + '/js/reader-tip.js?v=81',
  BASE + '/js/reader-words.js?v=81',
  BASE + '/js/reader-speak.js?v=81',
  BASE + '/js/reader-cards.js?v=81',
  BASE + '/js/reader-dict.js?v=81',
