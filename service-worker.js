const CACHE = 'deutsch-meister-v93';
...
const STATIC = [
  ...
  BASE + '/index.html',
  BASE + '/manifest.json',
  BASE + '/css/base.css?v=78',
  BASE + '/css/sidebar.css?v=78',
  BASE + '/css/lesson.css?v=78',
  BASE + '/css/exercises.css?v=78',
  BASE + '/js/progress.js?v=78',
  BASE + '/js/lesson-render.js?v=78',
  BASE + '/js/exercises.js?v=78',
  BASE + '/js/flashcards.js?v=78',
  BASE + '/js/tts.js?v=78',
  BASE + '/js/telegram.js?v=78',
  BASE + '/js/cloud-sync.js?v=78',
  BASE + '/js/install-app.js?v=78',
  BASE + '/js/support.js?v=78',
  BASE + '/js/sw-register.js?v=78',
  ...
  BASE + '/books.html',
  BASE + '/css/reader.css?v=78',
  BASE + '/js/library.js?v=78',
  BASE + '/js/reader.js?v=78',
  BASE + '/js/reader-tip.js?v=78',
  BASE + '/js/reader-words.js?v=78',
  BASE + '/js/reader-speak.js?v=78',
  BASE + '/js/reader-cards.js?v=78',
  BASE + '/js/reader-dict.js?v=78',
