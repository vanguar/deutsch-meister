const CACHE = 'deutsch-meister-v76';
...
const STATIC = [
  ...
  BASE + '/index.html',
  BASE + '/manifest.json',
  BASE + '/css/base.css?v=61',
  BASE + '/css/sidebar.css?v=61',
  BASE + '/css/lesson.css?v=61',
  BASE + '/css/exercises.css?v=61',
  BASE + '/js/progress.js?v=61',
  BASE + '/js/lesson-render.js?v=61',
  BASE + '/js/exercises.js?v=61',
  BASE + '/js/flashcards.js?v=61',
  BASE + '/js/tts.js?v=61',
  BASE + '/js/telegram.js?v=61',
  BASE + '/js/cloud-sync.js?v=61',
  BASE + '/js/install-app.js?v=61',
  BASE + '/js/support.js?v=61',
  BASE + '/js/sw-register.js?v=61',
  ...
  BASE + '/books.html',
  BASE + '/css/reader.css?v=61',
  BASE + '/js/library.js?v=61',
  BASE + '/js/reader.js?v=61',
  BASE + '/js/reader-tip.js?v=61',
  BASE + '/js/reader-words.js?v=61',
  BASE + '/js/reader-speak.js?v=61',
  BASE + '/js/reader-cards.js?v=61',
  BASE + '/js/reader-dict.js?v=61',
