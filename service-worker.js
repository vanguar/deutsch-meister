const CACHE = 'deutsch-meister-v80';
...
const STATIC = [
  ...
  BASE + '/index.html',
  BASE + '/manifest.json',
  BASE + '/css/base.css?v=65',
  BASE + '/css/sidebar.css?v=65',
  BASE + '/css/lesson.css?v=65',
  BASE + '/css/exercises.css?v=65',
  BASE + '/js/progress.js?v=65',
  BASE + '/js/lesson-render.js?v=65',
  BASE + '/js/exercises.js?v=65',
  BASE + '/js/flashcards.js?v=65',
  BASE + '/js/tts.js?v=65',
  BASE + '/js/telegram.js?v=65',
  BASE + '/js/cloud-sync.js?v=65',
  BASE + '/js/install-app.js?v=65',
  BASE + '/js/support.js?v=65',
  BASE + '/js/sw-register.js?v=65',
  ...
  BASE + '/books.html',
  BASE + '/css/reader.css?v=65',
  BASE + '/js/library.js?v=65',
  BASE + '/js/reader.js?v=65',
  BASE + '/js/reader-tip.js?v=65',
  BASE + '/js/reader-words.js?v=65',
  BASE + '/js/reader-speak.js?v=65',
  BASE + '/js/reader-cards.js?v=65',
  BASE + '/js/reader-dict.js?v=65',
