const CACHE = 'deutsch-meister-v94';
...
const STATIC = [
  ...
  BASE + '/index.html',
  BASE + '/manifest.json',
  BASE + '/css/base.css?v=79',
  BASE + '/css/sidebar.css?v=79',
  BASE + '/css/lesson.css?v=79',
  BASE + '/css/exercises.css?v=79',
  BASE + '/js/progress.js?v=79',
  BASE + '/js/lesson-render.js?v=79',
  BASE + '/js/exercises.js?v=79',
  BASE + '/js/flashcards.js?v=79',
  BASE + '/js/tts.js?v=79',
  BASE + '/js/telegram.js?v=79',
  BASE + '/js/cloud-sync.js?v=79',
  BASE + '/js/install-app.js?v=79',
  BASE + '/js/support.js?v=79',
  BASE + '/js/sw-register.js?v=79',
  ...
  BASE + '/books.html',
  BASE + '/css/reader.css?v=79',
  BASE + '/js/library.js?v=79',
  BASE + '/js/reader.js?v=79',
  BASE + '/js/reader-tip.js?v=79',
  BASE + '/js/reader-words.js?v=79',
  BASE + '/js/reader-speak.js?v=79',
  BASE + '/js/reader-cards.js?v=79',
  BASE + '/js/reader-dict.js?v=79',
