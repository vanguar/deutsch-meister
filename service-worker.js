const CACHE = 'deutsch-meister-v95';
...
const STATIC = [
  ...
  BASE + '/index.html',
  BASE + '/manifest.json',
  BASE + '/css/base.css?v=80',
  BASE + '/css/sidebar.css?v=80',
  BASE + '/css/lesson.css?v=80',
  BASE + '/css/exercises.css?v=80',
  BASE + '/js/progress.js?v=80',
  BASE + '/js/lesson-render.js?v=80',
  BASE + '/js/exercises.js?v=80',
  BASE + '/js/flashcards.js?v=80',
  BASE + '/js/tts.js?v=80',
  BASE + '/js/telegram.js?v=80',
  BASE + '/js/cloud-sync.js?v=80',
  BASE + '/js/install-app.js?v=80',
  BASE + '/js/support.js?v=80',
  BASE + '/js/sw-register.js?v=80',
  ...
  BASE + '/books.html',
  BASE + '/css/reader.css?v=80',
  BASE + '/js/library.js?v=80',
  BASE + '/js/reader.js?v=80',
  BASE + '/js/reader-tip.js?v=80',
  BASE + '/js/reader-words.js?v=80',
  BASE + '/js/reader-speak.js?v=80',
  BASE + '/js/reader-cards.js?v=80',
  BASE + '/js/reader-dict.js?v=80',
